...
LRESULT OnDvdEvent(LONG lEvent, LONG_PTR lParam1, LONG_PTR lParam2)
{
    ...
    switch(lEvent)
    {
        ...
        case EC_DVD_CHAPTER_START:
            g_ulCurChapter = static_cast<ULONG>(lParam1);
        ...
        case EC_DVD_TITLE_CHANGE:
            g_ulCurTitle = static_cast<ULONG>(lParam1);
            ResetRate();
        ...
        case EC_DVD_SUBPICTURE_STREAM_CHANGE:
            ...
            g_nCurrentSubpicture = static_cast<DWORD>(lParam1);
            UpdateSubpictureInfo();
            break;

        case EC_DVD_AUDIO_STREAM_CHANGE:
            g_nCurrentAudioStream = static_cast<DWORD>(lParam1);
            UpdateAudioInfo();
            break;
        ...
        case EC_DVD_ANGLE_CHANGE:
            ...
            g_nCurrentAngle = static_cast<DWORD>(lParam2);  
            UpdateAngleInfo();
            break;
        ...
        case EC_DVD_ANGLES_AVAILABLE:
            ...
            EnableAngleMenu(static_cast<BOOL>(lParam1));
            break;
        ...
        case EC_DVD_VALID_UOPS_CHANGE:
            g_ulValidUOPS = static_cast<ULONG>(lParam1);
            break;
        ...
        case EC_DVD_DOMAIN_CHANGE:
            ...
            g_DVDDomain = static_cast<DVD_DOMAIN>(lParam1);
            ResetRate();
            break;

        case EC_DVD_ERROR:
            DbgLog((LOG_TRACE, 3, TEXT("DVD Event: Error event received (code %ld)!\0"), 
