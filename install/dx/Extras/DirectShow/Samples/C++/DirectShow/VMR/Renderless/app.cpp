...
const DWORD g_Style         = WS_THICKFRAME | WS_POPUP | WS_CAPTION  |
...
const TBBUTTON tbButtons[DEFAULT_TBAR_SIZE] = {
    ...
    { IDX_SEPARATOR,    1,                    0,               TBSTYLE_SEP           },
    { IDX_4,            IDM_FULL_SCREEN,      TBSTATE_ENABLED, TBSTYLE_CHECK,  RESERVED, 0, -1 }
};
    ...
    )
{
    ...
    */
    ...
    SendMessage(g_hwndToolbar, TB_ENABLEBUTTON, IDM_FULL_SCREEN, 
                fVideoCdLoaded && (g_State & VCD_PLAYING));
}
...
SetFullScreenMode(BOOL bMode)
{
    ...
    pMovie->SetFullScreenMode(bMode);
