...
copy "%~dp0src\QtCore\QtCore\vcxproj\QtCore_lib.vcxproj.user" "%~dp0src\QtCore\QtCore\vcxproj\QtCore_lib.vcxproj.1user"
...
copy "%~dp0src\QtControls\QtControls\vcxproj\QtControls_lib.vcxproj.user" "%~dp0src\QtControls\QtControls\vcxproj\QtControls_lib.vcxproj.1user"
...
copy "%~dp0src\DialogManager\DialogManager\vcxproj\DialogManager_lib.vcxproj.user" "%~dp0src\DialogManager\DialogManager\vcxproj\DialogManager_lib.vcxproj.1user"
...
copy "%~dp0src\QtCore\QtCore\vcxproj\QtCore_lib.vcxproj.1user" "%~dp0src\QtCore\QtCore\vcxproj\QtCore_lib.vcxproj.user"
del "%~dp0src\QtCore\QtCore\vcxproj\QtCore_lib.vcxproj.1user"
...
copy "%~dp0src\QtControls\QtControls\vcxproj\QtControls_lib.vcxproj.1user" "%~dp0src\QtControls\QtControls\vcxproj\QtControls_lib.vcxproj.user"
del "%~dp0src\QtControls\QtControls\vcxproj\QtControls_lib.vcxproj.1user"
...
copy "%~dp0src\DialogManager\DialogManager\vcxproj\DialogManager_lib.vcxproj.1user" "%~dp0src\DialogManager\DialogManager\vcxproj\DialogManager_lib.vcxproj.user"
del "%~dp0src\DialogManager\DialogManager\vcxproj\DialogManager_lib.vcxproj.1user"
