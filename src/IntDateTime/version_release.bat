...
::编译工程
call "%bat%scripts\rebuild_IntDateTime.py"
...
rmdir /q /s "%bat%IntDateTime\vcxproj\Release\"

::删除ilk，exp
del "%xueyelingshuang%lib\IntDateTime.ilk"
del "%xueyelingshuang%lib\IntDateTime.exp"