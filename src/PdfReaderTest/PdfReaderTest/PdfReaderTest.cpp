...
void PdfReaderTest::init()
{
	...
	//QObject::connect(m_button, &COriginalButton::clicked, this, &PdfReaderTest::onButtonClicked);
}

bool PdfReaderTest::check()
{
	return true;
	return m_button != nullptr;
}

void PdfReaderTest::resizeEvent(QResizeEvent* eve)
{
...
void PdfReaderTest::onButtonClicked()
{
