...
::编译工程
call "%bat%scripts\rebuild_Controller.py"
...
rmdir /q /s "%bat%Controller\vcxproj\Release\"

::删除ilk，exp
del "%xueyelingshuang%lib\Controller.ilk"
del "%xueyelingshuang%lib\Controller.exp"