...
::编译工程
call "%bat%scripts\rebuild_CKeyboard.py" debug
...
rmdir /q /s "%bat%CKeyboard\vcxproj\Debug\"

::删除ilk，exp
del "%xueyelingshuang%lib\CKeyboardd.ilk"
del "%xueyelingshuang%lib\CKeyboardd.exp"
