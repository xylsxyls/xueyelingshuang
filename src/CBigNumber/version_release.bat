...
::编译工程
call "%bat%scripts\rebuild_CBigNumber.py"
...
rmdir /q /s "%bat%CBigNumber\vcxproj\Release\"

::删除ilk，exp
del "%xueyelingshuang%lib\CBigNumber.ilk"
del "%xueyelingshuang%lib\CBigNumber.exp"