...
#include <afxctl.h>
//#import "D:\\安装包\\dtws\\dm\\dm.dll" no_namespace \
...
public:
	...
	long DmStrStr(LPCTSTR s, LPCTSTR str)
	{
		long result;
	...
	long DmSetWindowText(long hwnd, LPCTSTR text)
	{
		long result;
	...
	long DmFindWindow(LPCTSTR class_name, LPCTSTR title_name)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR;
	...
	long DmFindWindowEx(long parent, LPCTSTR class_name, LPCTSTR title_name)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_BSTR VTS_BSTR;
	...
	long DmFindWindowByProcess(LPCTSTR process_name, LPCTSTR class_name, LPCTSTR title_name)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR;
	...
	long DmFindWindowByProcessId(long process_id, LPCTSTR class_name, LPCTSTR title_name)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_BSTR VTS_BSTR;
	...
	long DmFindWindowSuper(LPCTSTR spec1, long flag1, long type1, LPCTSTR spec2, long flag2, long type2)
	{
		long result;
	...
	long DmCopyFile(LPCTSTR src_file, LPCTSTR dst_file, long over)
	{
		long result;
	...
	long DmDeleteFile(LPCTSTR file)
	{
		long result;
		static BYTE parms[] = VTS_BSTR;
	...
	long DmMoveFile(LPCTSTR src_file, LPCTSTR dst_file)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR;
