...
void SplitViewer::init()
{
	...
	//QObject::connect(m_button, &COriginalButton::clicked, this, &SplitViewer::onButtonClicked);
}

bool SplitViewer::check()
{
	return true;
	return m_button != nullptr;
}

void SplitViewer::resizeEvent(QResizeEvent* eve)
{
...
void SplitViewer::onButtonClicked()
{
