...
class ControlsAPI SubAccountItem : public QStandardItem
{
public:
...
class ControlsAPI SubAccountItemDelegate : public QStyledItemDelegate
{
public:
...
class ControlsAPI SubAccountPanel : public QWidget
{
    Q_OBJECT
public:
