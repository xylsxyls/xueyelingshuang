...
m_ignore(nullptr)
{
    ...
    setPopButtonConfig(m_accept, QStringLiteral("确定"), QColor(166, 183, 249, 255), ACCEPT_BUTTON, 13);
    ...
    setPopButtonConfig(m_ignore, QStringLiteral("取消"), QColor(166, 183, 249, 255), IGNORE_BUTTON, 13);
