...
class ControlsAPI LockedAccountItem :public QStandardItem
{
public:
...
class ControlsAPI LockedAccountItemDelegate : public QStyledItemDelegate
{
public:
...
class ControlsAPI LockedAccountPanel : public QWidget
{
public:
