...
#include "../../../../qtcombobox/ExternalControls/CheckBox.h"
...
const QMetaObject CheckBox::staticMetaObject = {
    { &ControlShow<QCheckBox>::staticMetaObject, qt_meta_stringdata_CheckBox.data,
...
void *CheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ControlFont<QCheckBox>"))
        return static_cast< ControlFont<QCheckBox>*>(const_cast< CheckBox*>(this));
    if (!strcmp(_clname, "ControlBorderForNormalHoverPressedDisabledAndCheck<QCheckBox>"))
        return static_cast< ControlBorderForNormalHoverPressedDisabledAndCheck<QCheckBox>*>(const_cast< CheckBox*>(this));
    if (!strcmp(_clname, "ControlBackgroundForNormalHoverPressedDisabledAndCheck<QCheckBox>"))
        return static_cast< ControlBackgroundForNormalHoverPressedDisabledAndCheck<QCheckBox>*>(const_cast< CheckBox*>(this));
    return ControlShow<QCheckBox>::qt_metacast(_clname);
}

int CheckBox::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ControlShow<QCheckBox>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
