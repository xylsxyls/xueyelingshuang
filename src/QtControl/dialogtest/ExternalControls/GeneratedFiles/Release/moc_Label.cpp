...
#include "../../../../qtcombobox/ExternalControls/Label.h"
...
const QMetaObject Label::staticMetaObject = {
    { &ControlShow<QLabel>::staticMetaObject, qt_meta_stringdata_Label.data,
...
void *Label::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ControlBackgroundForNormalHoverDisabled<QLabel>"))
        return static_cast< ControlBackgroundForNormalHoverDisabled<QLabel>*>(const_cast< Label*>(this));
    return ControlShow<QLabel>::qt_metacast(_clname);
}

int Label::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = ControlShow<QLabel>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
